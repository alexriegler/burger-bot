...
hidden if the `burger-bot_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `burger-bot_DEVELOPER_MODE` to the configure
...
Runs the executable target `burger-bot_exe`.
